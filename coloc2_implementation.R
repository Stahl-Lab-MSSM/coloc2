# This replaces Chris' function below
...
coloc.abf <- function(dataset1, dataset2, MAF=NULL, 
                      p1=1e-4, p2=1e-4, p12=1e-5, ave=TRUE) {
  ...
  df1 <- process.dataset(d=dataset1, suffix="df1", ave=ave)
  df2 <- process.dataset(d=dataset2, suffix="df2", ave=ave)
